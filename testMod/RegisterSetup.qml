...
Dialog{
    property alias addressValueFrom: spinBoxAddress.value
    property alias addressValueTo: spinBoxAddressto.value
    //property alias nameElement:textName.text
    //property bool sliderSelect:myComboBox.currentIndex ? 0:1
